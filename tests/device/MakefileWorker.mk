...
ifeq ($(CPPUTEST_USE_MEM_LEAK_DETECTION), N)
    ...
    ifndef CPPUTEST_MEMLEAK_DETECTOR_NEW_MACRO_FILE
		CPPUTEST_MEMLEAK_DETECTOR_NEW_MACRO_FILE = -include $(UNITTEST_ROOT)/header_overrides/NewMacros.h
    endif
...
TEST_DEPS = $(TEST_OBJS) $(OBJ) $(MOCKS_OBJS) $(PRODUCTION_CODE_START) $(USER_LIBS) $(PRODUCTION_CODE_END) $(CPPUTEST_LIB) $(STDLIB_CODE_START)
test-deps: $(TEST_DEPS)
